...
python inference/infer_multi_command.py  \
    ...
    --seed 1234 \
    --CL_method FIX \
    --inference_output_path ./outputs_LLM-CL/cl_O_long_order3/$model_name/FIX_$now/predictions

# Collect results:
python inference/collect_results.py --inference_tasks yelp,amazon,MNLI,CB,COPA,QQP,RTE,IMDB,SST-2,dbpedia,agnews,yahoo,MultiRC,BoolQA,WiC --data_path ./outputs_LLM-CL/cl_O_long_order3/$model_name/FIX_$now/predictions
