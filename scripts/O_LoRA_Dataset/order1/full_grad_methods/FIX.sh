...
python inference/infer_multi_command.py  \
    ...
    --seed 1234 \
    --CL_method FIX \
    --inference_output_path ./outputs_LLM-CL/cl_O_order1/$model_name/FIX_$now/predictions

# Collect results:
python inference/collect_results.py --inference_tasks dbpedia,amazon,yahoo,agnews --data_path ./outputs_LLM-CL/cl_O_order1/$model_name/FIX_$now/predictions
