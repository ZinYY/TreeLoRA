...
deepspeed --include=localhost:$gpu_nodes --master_port 25011 training/main.py  \
    ...
    --reg $reg
     > "./shell_outputs/${model}_${timestamp}.log" 2>&1
...
python inference/collect_results.py --inference_tasks dbpedia,amazon,yahoo,agnews --data_path ./outputs_LLM-CL/cl/$model_name/Tree_LoRA_$now/predictions
