...
python inference/infer_multi_command.py  \
    ...
    --seed 1234 \
    --CL_method FIX \
    --inference_output_path ./outputs_LLM-CL/cl/$model_name/FIX_$now/predictions

# Collect results:
python inference/collect_results.py --inference_tasks C-STANCE,FOMC,MeetingBank,Py150,ScienceQA,NumGLUE-cm,NumGLUE-ds,20Minuten --data_path ./outputs_LLM-CL/cl/$model_name/FIX_$now/predictions
